...
pushnem = Haikal.contacts[num] != undefined ? Haikal.contacts[num].notify = undefined ? PhoneNumber('+' + num.replace('@s.whatsapp.net', '')).getNumber('international') : Haikal.contacts[num].notify || Haikal.contacts[num].vname : PhoneNumber('+' + num.replace('@s.whatsapp.net', '')).getNumber('international')
			try {
				...
				exec(`magick './media/image/promote.jpg' -gravity west -fill '#ffffff' -font './media/font/font-gue.ttf' -size 1280x710 -pointsize 75 -interline-spacing 7.5 -annotate +460-47 '${resa}' -pointsize 51 -annotate +460+83 '${jm} ${calender}' -pointsize 48 -annotate +100+230 'MEMBER + ${behys}' -pointsize 63 -annotate +460+200 'Promote ${mdata.subject}' '${ppimg}' -resize %[fx:t?u.w*0.2:u.w]x%[fx:?u.h*0.2:u.h] -gravity center -geometry -430+66 -composite './stik/hasil2.jpg'`)
...
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
- Hello  @${num.split('@')[0]}\n
- Anda Telah Menjadi Admin Group 
- ${mdata.subject}
- Jadilah Admin Yang Bijak Dan Dewasa 👋
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
...
pushnem = Haikal.contacts[num] != undefined ? Haikal.contacts[num].notify = undefined ? PhoneNumber('+' + num.replace('@s.whatsapp.net', '')).getNumber('international') : Haikal.contacts[num].notify || Haikal.contacts[num].vname : PhoneNumber('+' + num.replace('@s.whatsapp.net', '')).getNumber('international')
			try {
				...
				exec(`magick './media/image/demote.jpg' -gravity west -fill '#ffffff' -font './media/font/font-gue.ttf' -size 1280x710 -pointsize 75 -interline-spacing 7.5 -annotate +460-47 '${resa}' -pointsize 51 -annotate +460+83 '${jamny} ${calender}' -pointsize 48 -annotate +100+230 'MEMBER - ${behys}' -pointsize 63 -annotate +460+200 'Demote ${mdata.subject}' '${ppimg}' -resize %[fx:t?u.w*0.2:u.w]x%[fx:?u.h*0.2:u.h] -gravity center -geometry -430+66 -composite './stik/hasil3.jpg'`)
				.on('error', () => Haikal.sendMessage(m.chat, 'error', MessageType.text))
				.on('exit', () => {
...
- PASANGAN :
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
JANGAN LUPA SUBSCRIBE : https://youtube.com/channel/UCa37vxxUI-XULKw_sHb4A5g
▬▭▬▭▬▭▬▭▬▬▭▬▭▬`, contextInfo: { mentionedJid: [num] }})
			})
...
pushnem = Haikal.contacts[num] != undefined ? Haikal.contacts[num].notify = undefined ? PhoneNumber('+' + num.replace('@s.whatsapp.net', '')).getNumber('international') : Haikal.contacts[num].notify || Haikal.contacts[num].vname : PhoneNumber('+' + num.replace('@s.whatsapp.net', '')).getNumber('international')
			try {
				...
				exec(`magick './media/image/lev.jpg' -gravity west -fill '#ffffff' -font './media/font/font-gue.ttf' -size 1280x710 -pointsize 75 -interline-spacing 7.5 -annotate +460-47 '${resa}' -pointsize 51 -annotate +460+83 '${jamny} ${calender}' -pointsize 48 -annotate +100+230 'MEMBER - ${behys}' -pointsize 63 -annotate +460+200 'Goodbye ${mdata.subject}' '${ppimg}' -resize %[fx:t?u.w*0.2:u.w]x%[fx:?u.h*0.2:u.h] -gravity center -geometry -430+66 -composite './stik/hasil1.jpg'`)
				.on('error', () => Haikal.sendMessage(m.chat, 'error', MessageType.text))
				.on('exit', () => {
			Haikal.sendMessage(mdata.id, fs.readFileSync('./stik/hasil1.jpg'), MessageType.image, {caption: `*MY NAME HW MODS BOT*
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
┏━━⊱
┣❏ DADAH BEBAN KELUARGA 👋🏻
┣❏ @${num.split('@')[0]}\n
